...
const Nav = ({ setDarkMode, darkMode }) => {
  ...
  return (
    <nav className="sticky top-0 z-30 dark:bg-gray-900 bg-opacity-90 dark:bg-opacity-90  dark:text-white backdrop-filter backdrop-blur-lg border-b-2 border-gray-200 dark:border-gray-600">
      <div className="container max-w-7xl mx-auto py-3 md:py-5 px-4 xl:px-0">
